...
else if (usersState = "NE" && usersTemperature >= 32 && usersTemperature <=50)
  console.log(messages[1])
else if (usersState = "FL" && usersTemperature >= 32 && usersTemperature <=50)
  console.log(messages[2])
else if (usersState = "FL" && usersTemperature >= 50 && usersTemperature <=70)
